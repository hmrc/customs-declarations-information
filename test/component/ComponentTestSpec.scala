...
trait ComponentTestSpec extends FeatureSpec
  ...
  protected val configMap: Map[String, Any] = Map(
    ...
    "microservice.services.declaration-search.host" -> ExternalServicesConfig.Host,
    "microservice.services.declaration-search.port" -> ExternalServicesConfig.Port,
    "microservice.services.declaration-search.context" -> CustomsDeclarationsExternalServicesConfig.BackendSearchDeclarationServiceContextV1,
    "microservice.services.declaration-search.bearer-token" -> ExternalServicesConfig.AuthToken,
    "microservice.services.v2.declaration-search.host" -> ExternalServicesConfig.Host,
    "microservice.services.v2.declaration-search.port" -> ExternalServicesConfig.Port,
    "microservice.services.v2.declaration-search.context" -> CustomsDeclarationsExternalServicesConfig.BackendSearchDeclarationServiceContextV2,
    "microservice.services.v2.declaration-search.bearer-token" -> ExternalServicesConfig.AuthToken,
