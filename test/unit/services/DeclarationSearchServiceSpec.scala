...
import uk.gov.hmrc.customs.declarations.information.connectors.{ApiSubscriptionFieldsConnector, DeclarationSearchConnector, DeclarationVersionConnector, Non2xxResponseException}
...
import uk.gov.hmrc.customs.declarations.information.xml.{BackendSearchPayloadCreator, BackendStatusPayloadCreator}
...
class DeclarationSearchServiceSpec extends UnitSpec with MockitoSugar with BeforeAndAfterEach{
  ...
  protected lazy val mockDeclarationSearchConnector: DeclarationSearchConnector = mock[DeclarationSearchConnector]
  protected lazy val mockPayloadDecorator: BackendSearchPayloadCreator = mock[BackendSearchPayloadCreator]
