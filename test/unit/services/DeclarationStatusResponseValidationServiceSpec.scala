...
import uk.gov.hmrc.customs.declarations.information.model.{BadgeIdentifier, InformationConfig}
import uk.gov.hmrc.customs.declarations.information.services.{InformationConfigService, StatusResponseValidationService}
...
class DeclarationStatusResponseValidationServiceSpec extends UnitSpec with MockitoSugar {
  ...
  protected val mockLogger: InformationLogger = mock[InformationLogger]
  protected val mockInformationConfig: InformationConfig = mock[InformationConfig]
