...
import uk.gov.hmrc.customs.declarations.information.connectors.{DeclarationConnector, DeclarationVersionConnector}
...
class DeclarationVersionConnectorSpec extends UnitSpec with BeforeAndAfterEach with Eventually {
  ...
  private val successfulResponse = HttpResponse(OK, "")
